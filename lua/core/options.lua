...
-- Backup settings
opt.backup = false
opt.writebackup = false -- switches on or off the backup files
...
api.nvim_create_autocmd({ "BufEnter", "WinEnter" }, {
  callback = function()
    if vim.bo.buftype ~= "nofile" then
      ...
      -- stylua: ignore start
      ---@note For non-relative line number
      opt.statuscolumn =
...
-- Shows errors and warnings in a floating window
