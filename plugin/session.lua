...
map("n", "<leader>sl", ":SessionManager load_session<CR>", { desc = "Choose session to [L]oad" })
map("n", "<leader>sL", ":SessionManager load_last_session<CR>", { desc = "[L]oad [L]ast session" })
map(
  "n",
  "<leader>sd",
...
map("n", "<leader>ss", ":SessionManager save_current_session<CR>", { desc = "[S]ave current session" })
